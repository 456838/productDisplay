...
import static com.salton123.productdisplay.R.layout.activity_cate;
import static com.salton123.productdisplay.R.raw.pickup_cate;
        ...
        implements View.OnClickListener
{
    ...
    {
        return "android.resource://" + getPackageName() + "/" + pickup_cate;
    }
    ...
    private void initView()
    {
                ...
                paramAnonymousMediaPlayer.setOnInfoListener(new MediaPlayer.OnInfoListener()
                {
                    public boolean onInfo(MediaPlayer paramAnonymous2MediaPlayer, int paramAnonymous2Int1, int paramAnonymous2Int2)
                    {
                        if (paramAnonymous2Int1 == 3) {
                            CateActivity.this.mVideoView.setBackgroundColor(0);
                        }
                        return true;
                    }
                });
        ...
        this.mVideoView.setOnCompletionListener(new MediaPlayer.OnCompletionListener()
        {
            ...
            {
                ScreenUtils.setTouchTime(CateActivity.this, System.currentTimeMillis());
        CateActivity.this.rlParent.setVisibility(View.VISIBLE);
                ObjectAnimator  objectAnimator = ObjectAnimator.ofFloat(CateActivity.this.rlParent, "alpha", new float[] { 0.0F, 1.0F });
